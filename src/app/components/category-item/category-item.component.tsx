...
const CategoryItem: FunctionComponent<CategoryItemProps> = ({category}) => {
    return ( 
        ...
        <div className="flex items-center justify-center w-full h-full bg-center bg-cover rounded-xl shadow-xl cursor-pointer" style={{ backgroundImage: `url('${category.imageUrl}')`, height: '200px' }}>
